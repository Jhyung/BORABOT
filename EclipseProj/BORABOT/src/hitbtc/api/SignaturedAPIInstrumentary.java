...
//        System.out.println(result);
    ...
    public String loadGETURL2(String url) throws IOException, URISyntaxException, NoSuchAlgorithmException, InvalidKeyException, HitBTCAccessDenied {
        String result = loadGETURLAsString(url);
//        System.out.println("result");
//        System.out.println(result);
        return result;
    }
    
    public String loadGETURLAsString(String url) throws IOException, URISyntaxException, InvalidKeyException, NoSuchAlgorithmException, HitBTCAccessDenied {
