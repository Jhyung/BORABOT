...
//    	System.out.println("tradeAPI ! ");
//    	System.out.println(this.loadGETURL("balance", TradingBalances.class).balance);
    	
        return this.loadGETURL("balance", TradingBalances.class).balance;
    }
    
    public String getAllBalances2() throws IOException, URISyntaxException, InvalidKeyException, NoSuchAlgorithmException, HitBTCAccessDenied {
//    	System.out.println("tradeAPI ! ");
//    	System.out.println(this.loadGETURL("balance", TradingBalances.class).balance);
    	
    	String res = loadGETURLAsString("balance");
